                                ...
                                @foreach ($datas as $data)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-warning btn-sm" href="{{ route('pegawai.edit', $data->id) }}" title="edit"><i
                                                    class="font-small-2" data-feather='menu'>edit</i></a>
                                            <a class="btn btn-primary btn-sm" href="{{ route('pegawai.show', $data->id) }}" title="show"><i
